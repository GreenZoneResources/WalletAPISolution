...
namespace ZedCrestWalletApplication.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounterpartyTransactions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CustomerAccountInformations",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAccountInformations", x => x.Id);
                });
        }
